...
This package uses the wind model developed by Willoughby et al. [-@willoughby2006parametric] for modeling wind speed at each grid location. Full details on how this model is fit are provided in the "Details" vignetted of the `stormwindmodel` package.
