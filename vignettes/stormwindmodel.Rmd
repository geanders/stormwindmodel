...
- After imputing the tracks, we're expressing longitude as a positive number, to work correctly in the models. This means that we will need to graph the negative of longitude when mapping tracks from this point of the code forward.
