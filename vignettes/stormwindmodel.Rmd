...
However, it seems the old code uses distance, instead of velocity, to calculate `cspeed`. Below, `cspeed` is calculated using the old code, simply changing the last line to use the calculated velocities:
