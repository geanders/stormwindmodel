...
Next, we calculate the wind speed at each grid point (or county center location) for every storm observation. I've created the following function to do that:
