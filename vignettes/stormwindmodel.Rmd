...
var_names <- dplyr::data_frame(var = c("`vmax`",
                               ...
                               math = c("$V_{max}$",
                                        ...
                                        "$V_{F,v}$",
                                        "$\\theta$"),
                               defn = c("Max 10-m 10min sustained wind",
                                        "Max 10-m 10min sustained wind with motion asymmetry removed",
                                        "Max gradient-level 10min sustained wind",
                                        "Center position latitude",
                                        "Center position longitude (0 to 360)",
...
```{r warning = FALSE, fig.width = 8, fig.height = 6, message = FALSE, eval = FALSE}
