...
The old code adds 20 degrees for this inflow angle. However, in talking with John and Andrea, it sounds like an inflow angle of 40 degrees might be more reasonable over land, so I've changed the code to use a 40 degree inflow angle.
...
- From talking with John and Andrea, we probably also want to put this behind the part where we bring gradient values back down to surface estimates.
