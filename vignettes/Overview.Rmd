...
You can use the `stormwindmodel` package to model wind speeds at grid points in the United States based on "best tracks" hurricane tracking data and on a model for wind speed developed by Willoughby and coauthors [-@willoughby2006parametric]. 
